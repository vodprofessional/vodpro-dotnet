...
<p class="guiDialogNormal">
	...
	<cc1:Pane ID="resultsPane" runat="server" Visible="false">
        ...
        <ItemTemplate><asp:Literal ID="lt_email" runat="server"></asp:Literal>,<asp:Literal ID="lt_firstname" runat="server"></asp:Literal>,<asp:Literal ID="lt_lastname" runat="server"></asp:Literal>
</ItemTemplate></asp:Repeater></textarea>
    </cc1:Pane>
