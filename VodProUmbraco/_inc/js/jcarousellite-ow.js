  ...
  this.each(function() {
    ...
    touchEvents = {
      ...
      touchend: function(event) {
		...
		//  alert("Swipe [" + quickSwipe +"] delta [" + pxDelta + "]  absdelta [" + pxDelta + "] to [" +to+ "] \n\n primaryAxisGood["  + primaryAxisGood  + "] secondaryAxisGood ["+ secondaryAxisGood + "]");
        ...
        if ( quickSwipe && primaryAxisGood && secondaryAxisGood ) {
          ...
          swipeInfo.speed = o.speed / 2;
			...
			if ( (!quickSwipe && pxAbsDelta < styles.liSize / 2) ||
			  !primaryAxisGood || (quickSwipe && !secondaryAxisGood)) {
