...
<asp:CreateUserWizard ID="CreateUserWizard1" Runat="server" 
  ...
  <WizardSteps>
    ...
    <div class="formintrotext">
       <p>Welcome to VOD Professional. Registration is free and gives you access to website resources, special reports and email alerts.</p>
      <p>
...
<asp:DropDownList ID="Country" runat="server" CssClass="form-control smaller">
...
<asp:Label ID="Label19" runat="server" AssociatedControlID="txtOrgType">Organisation Type (If other, please specify)</asp:Label>
  <asp:DropDownList runat="server" ID="txtOrgType" CssClass="form-control orgtype">
  ...
  <asp:TextBox runat="server" ID="txtOrgTypeOther" CssClass="form-control orgtypeother" />
</div>
<div class="entry">
<asp:Label ID="Label20" runat="server" AssociatedControlID="txtEmployees">How many employees are there in your company? *</asp:Label>
  <asp:DropDownList runat="server" CssClass="form-control" ID="txtEmployees">
